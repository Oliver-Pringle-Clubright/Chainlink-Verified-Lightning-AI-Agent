...
using VerificationEntity = LightningAgentMarketPlace.Core.Models.Verification;

namespace LightningAgentMarketPlace.Engine.Workflows;
        ...
        CancellationToken ct = default)
    {
        ...
        if (passed)
        {
            ...
            try
            {
                ...
                {
                    var decryptedHex = LightningAgentMarketPlace.Engine.Security.PreimageProtector.Unprotect(escrow.PaymentPreimage ?? string.Empty);
